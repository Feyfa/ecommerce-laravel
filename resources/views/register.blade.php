...
@section('main')
    ...
    <div 
        ...
        <form 
            ...
            <div class="row flex flex-col gap-1 mt-5">
                ...
                <div class="relative">
                    <input 
                        ...
                        name="name" 
                        id="name"
                        class="w-full border border-neutral-500 h-12 pl-2.5 pr-11 outline-none rounded shadow @error('name') border-red-500 @enderror">
            ...
            <button type="submit" name="register_submit" class="w-full h-12 border border-neutral-300 rounded shadow bg-blue-500 hover:bg-[#428bff] mt-4">Register</button>
